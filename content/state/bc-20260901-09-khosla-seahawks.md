...
- confidence: medium
- selected_angle: Culture feature — NFL owners unanimously approved sale 26 Aug 2026; kickoff 9 Sep; approved-not-closed unless verified; Neeru Khosla as control owner only if Sportico memo (or a stronger primary) still holds; not “first Indian/South Asian NFL owner.”

## Why now

NFL owners **unanimously approved** the sale on **26 August 2026**. Regular-season kickoff is **Wednesday 9 September 2026** (Seahawks vs Patriots) — eight days. ESPN (26 Aug) said closing *could* happen before kickoff; that is not the same as closed. Culture angle: Neeru Khosla as **control owner** (Sportico citing an NFL club memo), not a "tech billionaire buys a toy" lede.

Discovery record lived on unmerged PR #6 (`discovery/20260901-production-queue`). This file is the canonical per-ID record, copied from that discovery body. PR #6 is not merged and is not a source of live facts.

## Sources seen

Discovery-era URLs (to be re-fetched 2026-09-01):

- https://www.seahawks.com/news/nfl-owners-approve-sale-of-seahawks-to-khosla-family (team primary, 26 Aug 2026)
- https://africa.espn.com/nfl/story/_/id/49733969/nfl-owners-approve-seahawks-sale-khosla-group (Brady Henderson / ESPN, 26 Aug 2026) — use the US ESPN URL in research
- https://apnews.com/article/nfl-owners-seahawks-sale-cbeece035eb56f26c7d789a2b8971f01 (AP, 26 Aug 2026)
- https://www.sportico.com/business/team-sales/2026/seattle-seahawks-sale-nfl-owners-approve-1234942967/ (Sportico; Neeru as control owner via NFL memo Sportico says it viewed)

FACT (discovery): unanimous owner approval 26 Aug; $9.612B figure is in ESPN/AP/Sportico; family publicly at the Atlanta meeting (Vinod, Neeru, Neal, Nina).
SIGNAL (discovery): kickoff-as-ceremony hope in local press.
INTERPRETATION (discovery): "son pushed the family into it" is on-record from Neeru in ESPN/AP — still not the whole story of control.
UNVERIFIED (discovery): whether the transaction has closed; final LP roster.
...
audience_relevance: 4 — sports + diaspora money/power; Seattle/Bay Area overlap.
timeliness: 5 — kickoff Wed 9 Sep (eight days); approval 26 Aug; closing still unverified.
cultural_relevance: 4 — named family, memo-attributed control owner, Khan/Jaguars block on “first.”
strength_of_angle: 4 — approved-not-closed + Neeru-on-the-memo + not-first is the add.
source_quality: 4 — team + NFL.com + ESPN + AP for approval/kickoff; control-owner is Sportico-viewed + ESPN-obtained memo, not seahawks.com.
originality: 4 — sports desk has the sale; culture desk can keep closing and control sourcing honest.
usefulness_shareability: 4 — stops a flattening “first Indian owner” recap before kickoff.
fit_with_brwncltr: 4 — sports in-scope as culture/who-controls, not cap-table.
veto: none
recommendation: (owner approved; research sufficient to draft)
confidence: high on approval/kickoff/not-closed/not-first; medium on Neeru title until team/NFL.com repeats it.
